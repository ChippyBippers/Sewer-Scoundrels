var width = make_odd(argument0)
var heigh = make_odd(argument1)

var rooms = ds_list_create()
var room_attempts = 100
var room_min_size = 5
var room_max_size = 9
randomize()
...
// Add rooms
for (var i = 0; i < room_attempts; i += 1) {
	...
	if valid {
		...
		with (inst) {
			...
			r_pos[0] = other.r_pos[0]
			r_pos[1] = other.r_pos[1]
		}
...
for (var r = 1; r < ds_list_size(rooms); r++) {
